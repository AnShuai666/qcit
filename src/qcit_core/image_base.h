...
#ifndef RECONSTRUCTION_IMAGE_BASE_H
#define RECONSTRUCTION_IMAGE_BASE_H

#include <cstdint>
#include <memory>
#include <vector>

#include "qcit_util/strings.h"
#include "qcit_core/defines.h"
...
template <class T>
inline void
swap (core::TypedImageBase<T>& a, core::TypedImageBase<T>& b)
{
    a.swap(b);
}
...
#endif //RECONSTRUCTION_IMAGE_BASE_H
